...
class TripletPhraserTest {
    ...
    fun `Should throw argument exception when input is out of supported range`(input: String) {
        Assertions.assertThrows(IllegalArgumentException::class.java) {
            TripletPhraser.phrase(input.toInt())
        }
    }
    ...
    fun `Should phrase two digit number`(numberAsString: String, expectedPhrase: String) {
    ...
    fun `Should phrase three digit number`(numberAsString: String, expectedPhrase: String) {
        assertPhrasedValue(numberAsString, expectedPhrase)
    }

    private fun assertPhrasedValue(numberAsString: String, expectedPhrasedNumber: String) {
        val phrasedNumber = TripletPhraser.phrase(numberAsString.toInt())
        assert(phrasedNumber == expectedPhrasedNumber) {
            print("Expected: $expectedPhrasedNumber, found: $phrasedNumber")
        }
    }
}